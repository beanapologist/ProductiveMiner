...
# Update Frontend Deployment with Correct Version
# This script updates the deployment with the current frontend version
...
print_status "🔄 Updating Frontend Deployment with Correct Version"
echo "=========================================================="
...
# Step 4: Create a new Dockerfile with the updated frontend
print_status "Creating new Dockerfile with updated frontend..."
...
# Add React Router support to the backend
...
print_success "Created Dockerfile with updated frontend"

# Step 5: Build the updated image
print_status "Building updated backend image..."
docker build -f Dockerfile.updated -t productiveminer-app-updated .

print_success "Built updated image"

# Step 6: Tag and push the updated image
print_status "Tagging and pushing updated image..."
docker tag productiveminer-app-updated $AWS_ACCOUNT_ID.dkr.ecr.$REGION.amazonaws.com/productiveminer-app:latest
...
echo "   - Added React Router support for all routes"
